...
namespace SDK
{
	...
	IViewRenderBeams*   shit::g_ViewRenderBeams = nullptr;			//Bullet Beams
	...
	IViewRenderBeams* shit::g_pViewRenderBeams()				//Bullet Beams
	{
		if (!g_ViewRenderBeams)
		{
			g_ViewRenderBeams = *reinterpret_cast<IViewRenderBeams**> (CSX::Memory::FindPatternV2(("client.dll"), ("A1 ? ? ? ? 56 8B F1 B9 ? ? ? ? FF 50 08")) + 0x1);
		}
