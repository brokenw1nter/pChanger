...
namespace Engine
{
	bool Initialize()
	{
		...
		*/
		...
		if (!SDK::shit::g_pViewRenderBeams())		//Bullet Beams
		{
			return false;
		}
	...
	void ClanTag()
	{
		...
		case 3:
		{
			SetMyClanTag("pChanger", "pChanger");
			break;
		}
		case 4:
		{
			SetMyClanTag("pChanger \r", "pChanger Only");
			break;
		}
		case 5:
		{
		...
		case 8:
		{
			...
			int value = ServerTime % 27;
			switch (value)
			{
			case 0:
			{
				SetMyClanTag("                  ", "pChanger Animation");
				break;
			}
			case 1:
			{
				SetMyClanTag("                 p", "pChanger Animation");
				break;
			}
			case 2:
			{
				SetMyClanTag("                pC", "pChanger Animation");
				break;
			}
			case 3:
			{
				SetMyClanTag("               pCh", "pChanger Animation");
				break;
			}
			case 4:
			{
				SetMyClanTag("              pCha", "pChanger Animation");
				break;
			}
			case 5:
			{
				SetMyClanTag("             pChan", "pChanger Animation");
				break;
			}
			case 6:
			{
				SetMyClanTag("            pChang", "pChanger Animation");
				break;
			}
			case 7:
			{
				SetMyClanTag("           pChange", "pChanger Animation");
				break;
			}
			case 8:
			{
				SetMyClanTag("          pChanger", "pChanger Animation");
				break;
			}
			case 9:
			{
			...
			case 19:
			{
				SetMyClanTag("Changer           ", "pChanger Animation");
				break;
			}
			case 20:
			{
				SetMyClanTag("hanger            ", "pChanger Animation");
				break;
			}
			case 21:
			{
				SetMyClanTag("anger             ", "pChanger Animation");
				break;
			}
			case 22:
			{
				SetMyClanTag("nger              ", "pChanger Animation");
				break;
			}
			case 23:
			{
				SetMyClanTag("ger               ", "pChanger Animation");
				break;
			}
			case 24:
			{
				SetMyClanTag("er                ", "pChanger Animation");
				break;
			}
			case 25:
			{
				SetMyClanTag("r                 ", "pChanger Animation");
				break;
			}
			case 26:
			{
	...
	{
		std::vector<std::string> chatspam = { "pChanger | Changing Things Up" };
	...
	void ChatSpamRandom()
	{
		std::vector<std::string> chatspamsss = { "pChanger | Changing Things Up" , "Using pChanger and Skills" , "Change Up The Game With pChanger" , "Some Things Should Be Changed" };
